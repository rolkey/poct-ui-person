        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="检验科/质管部门" prop="auditor2">
              <el-input
                v-model="queryParams.auditor2"
                placeholder="请输入检验科/质管部门"
                clearable
                @keyup.enter="handleQuery"
              />
            </el-form-item>
        ...
        <el-row ref="editButtonsRef" :gutter="10" class="mb-[6px]">
          <el-col :span="1.5">
            <el-button
              ...
              icon="Plus"
              @click="handleAdd"
              v-hasPermi="['his:personAuthorizeFlow:add']"
              >新增</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="single"
              @click="handleUpdate()"
              v-hasPermi="['his:personAuthorizeFlow:edit']"
              >修改</el-button
            >
          </el-col>
          <el-col :span="1.5">
          ...
          <el-col :span="1.5">
            <el-button
              ...
              icon="Download"
              @click="handleExport"
              v-hasPermi="['his:personAuthorizeFlow:export']"
              >导出</el-button
            >
          </el-col>
...
import {
  listPersonAuthorizeFlow,
  getPersonAuthorizeFlow,
...
import {
  ...
  PersonAuthorizeFlowQuery,
  PersonAuthorizeFlowForm,
} from "@/api/lis/person/personAuthorizeFlow/types";
...
const handleDelete = async (row?: PersonAuthorizeFlowVO) => {
  ...
  await proxy?.$modal
    .confirm('是否确认删除授权审批流编号为"' + _flowIds + '"的数据项？')
...
const handleExport = () => {
  proxy?.download(
    "his/personAuthorizeFlow/export",
    {
      ...queryParams.value,
    },
